...
class DataTransformation:
    ...
    def get_data_transformer_object(self)-> Pipeline:
        ...
        try:
            ...
            si_cate=SimpleImputer(strategy="most_frequent")
            ...
            preprocessor=ColumnTransformer(transformers=[
                ...
                ('si_cate',si_cate,si_cate_columns),
                ('si_num',si_num,si_num_columns),
                ("ohe",ohe_transformer,ohe_columns),
                ("ore",oe_transformer,oe_columns),
                ('pipe',transfrom_pipe,powertransform_columns)
