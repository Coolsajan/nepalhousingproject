...
class TrainPipleline:
    ...
    def start_data_transformation(self,data_ingestion_artifact:DataingestionArtifact,data_validation_artifact:DataValidationArtifact,data_transformation_artifact:DataValidationArtifact)->DataTransformationArtifact:
        """
    ...
    def run_pipleline(self, )->None:
            ...
            try:
                    ...
                    data_ingestion_artifact=self.start_data_transformation(data_ingestion_artifact=data_ingestion_artifact,data_validation_artifact=data_validation_artifact)
